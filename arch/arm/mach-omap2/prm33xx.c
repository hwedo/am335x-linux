...
{
	return __raw_readl(prm_base + inst + (idx / PRM_REG_SZ));
}

/* Write into a register in a PRM instance */
void am33xx_prm_write_reg(u32 val, s16 inst, u16 idx)
{
	__raw_writel(val, prm_base + inst + (idx / PRM_REG_SZ));
}
 ...
 * status registers: 4 bytes on AM33XX
 */
#define AM33XX_RST_CTRL_ST_OFFSET		4
